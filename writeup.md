...
![road](./output_images/undistort_road.jpg "Original and Undistorted road image")
...
![RGB channels](./output_images/RGBchannels.jpg "R G B channel images")
...
![HLS channels](./output_images/HLSchannels.jpg "H L S channel images")
...
![I1](./output_images/scale_1.jpg "scale image")

I2 and its gray scale image is as below

![I2](./output_images/scale_2.jpg "scale image")
...
![sobel](./output_images/sobel.jpg "sobel image")
...
![combined mask](./output_images/combined.jpg "combined mask image")
...
![warped](./output_images/warped.jpg "warped image")
...
![hist_search_fit](./output_images/hist_search_fit.jpg "histogram, searching windows and fitting lane line images")
---
...
![laneline](./output_images/laneline.jpg "lane line images")
...
![shadow_s](./output_images/shadow_s.jpg "shadow and s channel images")

the resulting mask image, searching window and final lane line images are as below

![shadow_final](./output_images/shadow_final.jpg)
...
![ls_channel](./output_images/ls_channel.jpg "Lightness and Saturation channel images")
...
![final_ls_mask](./output_images/final_ls_mask.jpg)
...
![shadow_ls_mask](./output_images/shadow_ls_final.jpg)
